...
export function SoundToggle({ className = "" }: { className?: string }) {
  ...
  return (
    <button
      ...
      aria-label={enabled ? "Disable the interactive cinematic soundscape" : "Enable the interactive cinematic soundscape"}
    ...
    >
      ...
      <span>{enabled ? "Soundscape On" : "Soundscape Off"}</span>
    </button>
  );
}
